...
class Lidar_subscriber(Node):
    ...
    def lidar_callback(self, msg):
        ...
        # We sample the front 180 degrees directly by index
        # This replaces the need for the self.gaps logic
        indices = np.linspace(90, 270, self.environment_dim).astype(int)
        self.lidar_data = raw_ranges[indices]
        self.get_logger().info(f"Front distance: {lidar_data[10]:.2f}m")
